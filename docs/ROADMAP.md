...
```text
[已完成 M0/M1] Phase 0–9/12/14：数据/特征/评分(A-D)/硬阀门/裁决/组合/路由/再建仓/镜像/WebUI 骨架，252 package tests + 11 golden tests 绿
      │
...
| ✅ P4 | 整合地基 Phase 0–I + Pipeline | INTEGRATION Phase 0–I | **已完成并落地本地：12 组件 + 252 package tests OK + 11 golden tests OK + E1–E30 全覆盖 + 7 闸结构验证** |
