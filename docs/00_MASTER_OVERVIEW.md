...
| **当前唯一关键瓶颈** | **P0 合成管线已建，但 FNGU overlap 年化 TE 8.42% > 5% → proxy 窗口暂不能用于 P1/NEXT-3** |
...
1. **P0 合成杠杆历史（最高优先·当前唯一阻塞）**：代码/数据管线已建，FNGU/FNGS 均扩到 2018-01-02；但 FNGU 严格 overlap TE 8.42% 未过 5% 门。下一步继续修 FNGU 合成质量，未过门前不启动 P1/NEXT-3。
