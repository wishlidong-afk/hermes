...
4. ~~**P4 整合地基**~~：✅ **Phase 0–I + Pipeline DONE** — 12 组件 + 270 package tests OK + 11 golden tests OK + E1–E30 全覆盖 + 7 闸验证，并已同步落地本地 `.hermes`。详见 `building/reports/P4_INTEGRATION_PHASE0_I_REPORT.md` 与 `building/logs/P4_LOCAL_SNAPSHOT_SYNC_LOG.md`。
