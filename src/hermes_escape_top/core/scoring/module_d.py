...
def module_d_factors(symbol: str) -> list[FactorDefinition]:
    factors = [
    ...
    factors.extend(_symbol_extra_factors(symbol))
    return factors
...
def _symbol_extra_factors(symbol: str) -> list[FactorDefinition]:
    if symbol == "MSTR":
        return [
            FactorDefinition(
