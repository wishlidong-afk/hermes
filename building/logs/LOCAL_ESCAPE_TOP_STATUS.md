...
| 15 集成、dry-run、切换 | **IN-PROGRESS / WARN-SENSITIVITY-DONE** | local only | shadow + WARN sensitivity passed | Phase II 252 日 shadow、相关闸敏感性、2113 日 full-window sensitivity 完成；P8 二次网格候选 `110/0.90`；270 package tests OK；live 开关保持关闭 | 2026-06-02 |
