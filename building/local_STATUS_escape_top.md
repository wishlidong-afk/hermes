...
| 15 集成、dry-run、切换 | **IN-PROGRESS / WARN-REVIEW-PACK-DONE** | local only | shadow + WARN review passed | Phase II 252 日 shadow、相关闸敏感性、2113 日 full-window sensitivity 完成；Phase III 252 日 daily comparator：errors=0、R3=0、BLOCK=0；P7 WARN review：REVIEW_REQUIRED；264 package tests OK；live 开关保持关闭 | 2026-06-02 |
...
| **P7 Phase III WARN review** | **DONE / WARN-REVIEW-PACK-DONE** | `scripts/phase3_warn_review.py`；`tests/test_phase3_warn_review.py`；`reports/PhaseIII_WARN_Review.md/json`；`reports/P7_PHASE3_WARN_REVIEW_LOG.md` | WARN=124；EXTREME_CORR=102；WARN forward candidate-old avg：1d -0.00%、5d -0.05%、10d -0.29%；264 package tests OK + 11 golden tests OK | readiness=REVIEW_REQUIRED；live 开关保持关闭 |
