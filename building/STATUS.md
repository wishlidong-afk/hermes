...
|---|---|---|---|---|---|
| 29 今日操作台可执行表述优化 | DONE / RUNTIME-VERIFIED | hermes-docs | 343 tests OK + 8766 Browser OK | 当前交易方向按 IBKR 差额算；若 IBKR 断线则会按缓存/0仓显示，需刷新持仓确认 | 2026-06-05 |
...
| **P13 Phase IV Gates 4/5/6** | **DONE / PHASE-IV-GATES-PASSED** | Gate4-6 全通过 | - |
| **P15 Gate 7 熔断端到端** | **DONE / ALL-7-GATES-PASSED** | 23 个注入测试全通过；293 总测试 OK；**7/7 道系统级总闸全部通过** | - |
