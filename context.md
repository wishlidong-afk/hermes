...
```json
{
  "baseline": {
    ...
    "git_commit": "360aceda45087216124565fbcfaceca6f9d7dca2"
  },
...
> **CURRENT EXECUTION EVIDENCE：**baseline 绑定 gate-code commit `360aced`、已提交的有效 live-config 快照、当前 history manifest 与 soft-history 指纹；可作为预注册 formal gate 的 next-open 对照，但不授权任何配置翻闸。
